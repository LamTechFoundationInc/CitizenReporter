...
public class AuthenticatorRequestTest extends InstrumentationTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        RestClient restClient = RestClientFactory.instantiate(null);
