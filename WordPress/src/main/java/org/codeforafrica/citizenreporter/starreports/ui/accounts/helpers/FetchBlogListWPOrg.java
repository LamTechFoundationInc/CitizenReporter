...
public class FetchBlogListWPOrg extends FetchBlogListAbstract {
    ...
    private void handleXmlRpcFault(XMLRPCFault xmlRpcFault) {
        ...
        switch (xmlRpcFault.getFaultCode()) {
            case 403:
                mErrorMsgId = org.codeforafrica.citizenreporter.starreports.R.string.username_or_password_incorrect;
                break;
            case 404:
                mErrorMsgId = org.codeforafrica.citizenreporter.starreports.R.string.xmlrpc_error;
                break;
            case 425:
                mErrorMsgId = org.codeforafrica.citizenreporter.starreports.R.string.account_two_step_auth_enabled;
                break;
            default:
                mErrorMsgId = org.codeforafrica.citizenreporter.starreports.R.string.no_site_error;
                break;
        }
    }
    ...
    private String getXmlrpcByUserEnteredPath(String baseUrl) {
        ...
        if (!UrlUtils.isValidUrlAndHostNotNull(baseUrl)) {
            ...
            mErrorMsgId = org.codeforafrica.citizenreporter.starreports.R.string.invalid_url_message;
            return null;
        }
