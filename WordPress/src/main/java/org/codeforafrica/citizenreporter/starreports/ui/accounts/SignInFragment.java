...
import org.codeforafrica.citizenreporter.starreports.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.codeforafrica.citizenreporter.starreports.ui.accounts.helpers.FetchBlogListWPCom;
import org.codeforafrica.citizenreporter.starreports.ui.accounts.helpers.FetchBlogListWPOrg;
import org.codeforafrica.citizenreporter.starreports.ui.accounts.helpers.LoginAbstract;
import org.codeforafrica.citizenreporter.starreports.ui.accounts.helpers.LoginWPCom;
import org.codeforafrica.citizenreporter.starreports.ui.reader.services.ReaderUpdateService;
import org.codeforafrica.citizenreporter.starreports.ui.reader.services.ReaderUpdateService.UpdateTask;
...
public class SignInFragment extends AbstractFragment implements TextWatcher {
    ...
    private String getForgotPasswordURL() {
        String baseUrl = BuildConfig.DEFAULT_URL;
        if (!isWPComLogin()) {
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        if (ABTestingUtils.isFeatureEnabled(Feature.HELPSHIFT)) {
            ...
            nuxAlert = SignInDialogFragment.newInstance(getString(org.codeforafrica.citizenreporter.starreports.R.string.nux_cannot_log_in),
                    getString(org.codeforafrica.citizenreporter.starreports.R.string.username_or_password_incorrect),
                    org.codeforafrica.citizenreporter.starreports.R.drawable.noticon_alert_big, 3, getString(
                            org.codeforafrica.citizenreporter.starreports.R.string.cancel), getString(
                            org.codeforafrica.citizenreporter.starreports.R.string.forgot_password), getString(
                            org.codeforafrica.citizenreporter.starreports.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
                    SignInDialogFragment.ACTION_OPEN_SUPPORT_CHAT);
        } else {
            // create a 2 buttons dialog ("Forget your password?" and "Cancel")
            nuxAlert = SignInDialogFragment.newInstance(getString(org.codeforafrica.citizenreporter.starreports.R.string.nux_cannot_log_in),
                    getString(org.codeforafrica.citizenreporter.starreports.R.string.username_or_password_incorrect),
                    org.codeforafrica.citizenreporter.starreports.R.drawable.noticon_alert_big, 2, getString(
                            org.codeforafrica.citizenreporter.starreports.R.string.cancel), getString(
                            org.codeforafrica.citizenreporter.starreports.R.string.forgot_password), null, SignInDialogFragment.ACTION_OPEN_URL,
                    0);
        }
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.codeforafrica.citizenreporter.starreports.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.codeforafrica.citizenreporter.starreports.R.string.invalid_url_message) {
