...
import org.codeforafrica.citizenreporter.starreports.ui.media.MediaGalleryActivity;
import org.codeforafrica.citizenreporter.starreports.ui.media.MediaGalleryPickerActivity;
import org.codeforafrica.citizenreporter.starreports.ui.media.MediaGridFragment;
import org.codeforafrica.citizenreporter.starreports.ui.media.MediaPickerActivity;
import org.codeforafrica.citizenreporter.starreports.ui.media.MediaSourceWPImages;
import org.codeforafrica.citizenreporter.starreports.ui.media.MediaSourceWPVideos;
import org.codeforafrica.citizenreporter.starreports.ui.media.WordPressMediaUtils;
import org.codeforafrica.citizenreporter.starreports.ui.media.services.MediaUploadEvents;
import org.codeforafrica.citizenreporter.starreports.ui.media.services.MediaUploadService;
import org.codeforafrica.citizenreporter.starreports.ui.posts.EditPostPreviewFragment;
import org.codeforafrica.citizenreporter.starreports.ui.posts.EditPostSettingsFragment;
import org.codeforafrica.citizenreporter.starreports.ui.posts.PostUploadService;
import org.codeforafrica.citizenreporter.starreports.ui.suggestion.adapters.TagSuggestionAdapter;
import org.codeforafrica.citizenreporter.starreports.ui.suggestion.util.SuggestionServiceConnectionManager;
import org.codeforafrica.citizenreporter.starreports.ui.suggestion.util.SuggestionUtils;
...
import org.codeforafrica.citizenreporter.starreports.widgets.SuggestionAutoCompleteText;
import org.codeforafrica.citizenreporter.starreports.widgets.WPViewPager;
...
public class StoryBoardActivity extends ActionBarActivity implements EditorFragmentListener {
    ...
    private void trackEditorCreatedPost(String action, Intent intent) {
        ...
        if (StoryBoardActivity.NEW_MEDIA_GALLERY.equals(action) || StoryBoardActivity.NEW_MEDIA_POST.equals(
                action)) {
    ...
    private class LoadPostContentTask extends AsyncTask<String, Spanned, Spanned> {
        ...
        protected Spanned doInBackground(String... params) {
            ...
            return WPHtml.fromHtml(content, StoryBoardActivity.this, getPost(), getMaximumThumbnailWidthForEditor());
        }
    ...
    private void fetchMedia(Uri mediaUri) {
        if (URLUtil.isNetworkUrl(mediaUri.toString())) {
            ...
            if (!addMedia(mediaUri)) {
                Toast.makeText(StoryBoardActivity.this, getResources().getText(R.string.gallery_error), Toast.LENGTH_SHORT)
                        .show();
            }
        }
    }
    ...
    private class DownloadMediaTask extends AsyncTask<Uri, Integer, Uri> {
        ...
        protected Uri doInBackground(Uri... uris) {
            Uri imageUri = uris[0];
            return MediaUtils.downloadExternalMedia(StoryBoardActivity.this, imageUri);
        }

        @Override
        protected void onPreExecute() {
            Toast.makeText(StoryBoardActivity.this, R.string.download, Toast.LENGTH_SHORT).show();
        }
        ...
        protected void onPostExecute(Uri newUri) {
            if (newUri != null) {
                ...
                Toast.makeText(StoryBoardActivity.this, getString(R.string.error_downloading_image), Toast.LENGTH_SHORT)
                        .show();
            }
        }
    }
        ...
        ApiHelper.EditMediaItemTask task = new ApiHelper.EditMediaItemTask(mf.getMediaId(), mf.getTitle(),
                ...
                new ApiHelper.GenericCallback() {
                    ...
                    public void onFailure(ApiHelper.ErrorType errorType, String errorMessage, Throwable throwable) {
                        Toast.makeText(StoryBoardActivity.this, R.string.media_edit_failure, Toast.LENGTH_LONG).show();
                    }
                });
    ...
    /**
     * Handles result from {@link org.codeforafrica.citizenreporter.starreports.ui.media.MediaPickerActivity}. Uploads local
     ...
     *  {@link org.codeforafrica.citizenreporter.starreports.ui.media.MediaPickerActivity#SELECTED_CONTENT_RESULTS_KEY}
     */
    ...
    /**
     * Handles result from {@link org.codeforafrica.citizenreporter.starreports.ui.media.MediaPickerActivity} by adding the
    ...
    /**
     * Starts {@link org.codeforafrica.citizenreporter.starreports.ui.media.MediaPickerActivity} after refreshing the blog media.
     */
        ...
        if (NetworkUtils.isNetworkAvailable(this)) {
            ...
            ApiHelper.SyncMediaLibraryTask.Callback callback = new ApiHelper.SyncMediaLibraryTask.Callback() {
                ...
                public void onFailure(final ApiHelper.ErrorType errorType, String errorMessage, Throwable throwable) {
                    mBlogMediaStatus = 0;
                    ToastUtils.showToast(StoryBoardActivity.this, R.string.error_refresh_media, ToastUtils.Duration.SHORT);
                }
            };
