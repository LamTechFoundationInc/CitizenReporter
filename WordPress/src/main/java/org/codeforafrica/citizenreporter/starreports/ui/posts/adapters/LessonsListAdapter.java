...
import org.codeforafrica.citizenreporter.starreports.ui.main.RipotiPostsListFragment;
...
public class LessonsListAdapter extends BaseAdapter {
    ...
    public LessonsListAdapter(Context context, boolean isPage, OnLoadMoreListener onLoadMoreListener, OnPostsLoadedListener onPostsLoadedListener) {
        mContext = context;
        mIsPage = isPage;
    ...
    private class LoadPostsTask extends AsyncTask <Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... nada) {
            loadedPosts = WordPress.wpDB.getLessons(WordPress.getCurrentLocalTableBlogId(), mIsPage);
