package org.codeforafrica.citizenreporter.starreports.ui.storyboard;
...
public class StoryBoardEditorFragment extends EditorFragmentAbstract implements TextWatcher,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.storyboard_fragment_edit_post_content, container, false);

        //quick capture icons
        button_camera = (ImageView)rootView.findViewById(R.id.button_camera);
        ...
        button_video = (ImageView)rootView.findViewById(R.id.button_video);
        button_mic = (ImageView)rootView.findViewById(R.id.button_mic);

        mFormatBar = (LinearLayout) rootView.findViewById(org.wordpress.android.editor.R.id.format_bar);
        mTitleEditText = (EditText) rootView.findViewById(org.wordpress.android.editor.R.id.post_title);
        ...
        mContentEditText = (WPEditText) rootView.findViewById(org.wordpress.android.editor.R.id.post_content);
        mContentEditText.setText(mContent);

        mPostContentLinearLayout = (LinearLayout) rootView.findViewById(org.wordpress.android.editor.R.id.post_content_wrapper);
        mPostSettingsLinearLayout = (LinearLayout) rootView.findViewById(org.wordpress.android.editor.R.id.post_settings_wrapper);
        Button postSettingsButton = (Button) rootView.findViewById(org.wordpress.android.editor.R.id.post_settings_button);
        ...
        mBoldToggleButton = (ToggleButton) rootView.findViewById(org.wordpress.android.editor.R.id.bold);
        mEmToggleButton = (ToggleButton) rootView.findViewById(org.wordpress.android.editor.R.id.em);
        mBquoteToggleButton = (ToggleButton) rootView.findViewById(org.wordpress.android.editor.R.id.bquote);
        mUnderlineToggleButton = (ToggleButton) rootView.findViewById(org.wordpress.android.editor.R.id.underline);
        mStrikeToggleButton = (ToggleButton) rootView.findViewById(org.wordpress.android.editor.R.id.strike);
        mAddPictureButton = (Button) rootView.findViewById(org.wordpress.android.editor.R.id.addPictureButton);
        Button linkButton = (Button) rootView.findViewById(org.wordpress.android.editor.R.id.link);
        Button moreButton = (Button) rootView.findViewById(org.wordpress.android.editor.R.id.more);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == StoryBoardEditorFragment.ACTIVITY_REQUEST_CODE_CREATE_LINK && data != null) {
    ...
    private View.OnClickListener mFormatBarButtonClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            } else if (id == org.wordpress.android.editor.R.id.strike) {
            ...
            } else if (id == org.wordpress.android.editor.R.id.link) {
            ...
            } else if (id == org.wordpress.android.editor.R.id.addPictureButton) {
    ...
    private WPEditImageSpan createWPEditImageSpanLocal(Context context, MediaFile mediaFile) {
        ...
        if (MediaUtils.isVideo(imageUri.toString())) {
            thumbnailBitmap = BitmapFactory.decodeResource(context.getResources(), org.wordpress.android.editor.R.drawable.media_movieclip);
        } else {
    ...
    private WPEditImageSpan createWPEditImageSpanRemote(Context context, MediaFile mediaFile) {
        int drawable = mediaFile.isVideo() ? org.wordpress.android.editor.R.drawable.media_movieclip : org.wordpress.android.editor.R.drawable.legacy_dashicon_format_image_big_grey;
    ...
    public void showImageSettings(final View alertView, final EditText titleText,
        ...
        builder.setTitle(getString(org.wordpress.android.editor.R.string.image_settings));
   ...
   @Override
            ...
            if (layout != null) {
                ...
                if (imageSpans.length != 0) {
                    ...
                    if (!mediaFile.isVideo()) {
                        ...
                        final View alertView = factory.inflate(org.wordpress.android.editor.R.layout.alert_image_options, null);
                        if (alertView == null)
                            return false;
                        final EditText imageWidthText = (EditText) alertView.findViewById(org.wordpress.android.editor.R.id.imageWidthText);
                        final EditText titleText = (EditText) alertView.findViewById(org.wordpress.android.editor.R.id.title);
                        final EditText caption = (EditText) alertView.findViewById(org.wordpress.android.editor.R.id.caption);
                        final CheckBox featuredCheckBox = (CheckBox) alertView.findViewById(org.wordpress.android.editor.R.id.featuredImage);
                        final CheckBox featuredInPostCheckBox = (CheckBox) alertView.findViewById(org.wordpress.android.editor.R.id.featuredInPost);
                        ...
                        final SeekBar seekBar = (SeekBar) alertView.findViewById(org.wordpress.android.editor.R.id.imageWidth);
                        final Spinner alignmentSpinner = (Spinner) alertView.findViewById(org.wordpress.android.editor.R.id.alignment_spinner);
                        ArrayAdapter<CharSequence> adapter =
                                ArrayAdapter.createFromResource(getActivity(), org.wordpress.android.editor.R.array.alignment_array,
    ...
    public void appendGallery(MediaGallery mediaGallery) {
        ...
        MediaGalleryImageSpan is = new MediaGalleryImageSpan(getActivity(), mediaGallery,
                org.wordpress.android.editor.R.drawable.legacy_icon_mediagallery_placeholder);
