...
import org.codeforafrica.citizenreporter.starreports.ui.posts.LessonsListFragment.OnPostActionListener;
import org.codeforafrica.citizenreporter.starreports.ui.posts.LessonsListFragment.OnPostSelectedListener;
import org.codeforafrica.citizenreporter.starreports.ui.posts.ViewPostFragment.OnDetailPostActionListener;
...
public class LessonsActivity extends ActionBarActivity
        implements OnPostSelectedListener, LessonsListFragment.OnSinglePostLoadedListener, OnPostActionListener,
    ...
    private LessonsListFragment mPostList;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ProfilingUtils.split("LessonsActivity.onCreate");
        ProfilingUtils.dump();
        ...
        mPostList = (LessonsListFragment) fm.findFragmentById(R.id.postList);
    ...
    private void showPostUploadErrorAlert(String errorMessage, String infoTitle,
        ...
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(LessonsActivity.this);
    ...
    public class deletePostTask extends AsyncTask<Post, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            attemptToSelectPost();
            if (result) {
                Toast.makeText(LessonsActivity.this, getResources().getText((mIsPage) ?
        ...
        private String prepareErrorMessage(Exception e) {
            AppLog.e(T.POSTS, "Error while deleting post or page", e);
    ...
    public void onPostAction(int action, final Post post) {
        // No post? No service.
        if (post == null) {
            Toast.makeText(LessonsActivity.this, R.string.post_not_found, Toast.LENGTH_SHORT).show();
            return;
        }
